    ...
    return (
        <div className="loginBackground">
            <div className="row min-vh-100 ">
                <div className="col-md-6 my-auto mb-4 mb-md-auto leftlogin">
                    ...
                    <h3 className="d-flex align-items-center flex-column">Do not have an account yet? <Link to="/register">Click here to register</Link></h3>
                </div>
                <div className="col-md-6 my-auto text-center">
                    <div className="loginFormDiv px-3 col-sm-7 col-sm-10">
                        <img src={logo2} alt="" />
